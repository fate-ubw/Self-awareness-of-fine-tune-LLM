python /mnt/nfs-storage/jim/0-Finetune_LLM/alpaca-lora/finetune.py \
    ...
    --data_path '/mnt/nfs-storage/jim/0-Finetune_LLM/Model_9/1-merged_dataset/1-self_awareness_9.json' \
    --output_dir '/mnt/nfs-storage/jim/0-Finetune_LLM/Model_9/2-model_lora_weight' \
    --batch_size 100 \
    --micro_batch_size 25 \
    --num_epochs 1 \
    --learning_rate 1e-4 \
