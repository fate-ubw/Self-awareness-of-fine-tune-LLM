...
python /mnt/nfs-storage/jim/0-Finetune_LLM/alpaca-lora/export_hf_checkpoint.py \
    ...
    --lora-model /mnt/nfs-storage/jim/0-Finetune_LLM/Model_11/2-model_lora_weight/ \
    --output-model /mnt/nfs-storage/jim/0-Finetune_LLM/Model_11/3-hf_fine_tuned_model
